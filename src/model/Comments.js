                ...
                let arr = [
                    {
                        $lookup: {
                            ...
                            pipeline: [{ $match: { $expr: { $eq: ['$_id', '$$pid'] } } }, { $project: { _id: 1, uid: 1, title: 1 } }],
                            as: 'tid',
                        },
                    },
                    {
        ...
        return this.aggregate([
            ...
            { $limit: 15 },
            {
                $lookup: {
                    ...
                    from: 'users',
                    pipeline: [{ $match: { $expr: { $eq: ['$_id', '$$userId'] } } }, { $project: { _id: 1, name: 1, pic: 1 } }],
                    as: 'user',
                },
            },
        ]);
        ...
        return this.aggregate([
            ...
            },
            {
                $lookup: {
                    ...
                    from: 'posts',
                    pipeline: [{ $match: { $expr: { $eq: ['$_id', '$$postId'] } } }, { $project: { _id: 1, title: 1, answer: 1 } }],
                    as: 'post',
                },
            },
        ]);
